...
class MLDv2(MLD):
    ...
    def __init__(self, proto_type=143, code=0, rtype=1,
                 chksum=None, src_ip="fe80::1", dst_ip="ff02::fb", records=[], *args, **kwargs):
        ...
        for record in records:
            self.records.append(ICMPv6MLDMultAddrRec(sources=[src_ip], dst=record, rtype=rtype))
...
if __name__ == "__main__":
    ...
    packet = MLDv2(records=args.record,
                        src_ip=args.src_ip,
                        dst_ip=args.dst_ip,
